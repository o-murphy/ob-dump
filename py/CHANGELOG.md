...
- Removed dead, commented-out "write transaction to initialize the root
  ...
  (see [`dart/CHANGELOG.md`](../dart/CHANGELOG.md) for the same finding,
  reached independently for the Dart package first).
...
[Unreleased]: https://github.com/o-murphy/ob-dump/commits/main/py
